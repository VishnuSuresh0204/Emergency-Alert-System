...
urlpatterns = [
    ...
    path('admin_edit_alert/', views.admin_edit_alert),
    ...
    path('citizen_view_news/', views.citizen_view_news),
    ...
    path('staff_post_news/', views.staff_post_news),
    path('staff_view_news/', views.staff_view_news),
    path('staff_edit_news/', views.staff_edit_news),
    path('staff_delete_news/', views.staff_delete_news),
    ...
    path('volunteer_view_news/', views.volunteer_view_news),
